...
int main(int argc, char *argv[]) {
  ...
  hipLaunchKernelGGL(TestKernel,dim3(NumOfThreadBlocks),dim3(ThreadBlockSize), 0, 0, D_Ptr);
...
/// CHECK-NEXT:  #0 [[PC]] in OffloadToGPU(int*) at {{.*}}/aomp/test/smoke-asan/hip-static-indirect-lbo/hip-static-indirect-lbo.cpp:19:{{[0-9]+}}
/// CHECK-NEXT: (inlined by) TestKernel(int*) at {{.*}}/aomp/test/smoke-asan/hip-static-indirect-lbo/hip-static-indirect-lbo.cpp:25:{{[0-9]+}}
